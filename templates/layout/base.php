                ...
                extend: {
                    colors: {
                        medical: {
                            ...
                            300: '#86efac',
                            400: '#4ade80',
                            500: '#10b981', // Emerald Base Accent
                            600: '#059669',
                            700: '#047857',
                            800: '#065f46',
                            900: '#064e3b',
...
<body class="bg-slate-50/50 text-slate-900 antialiased font-sans min-h-screen flex">
    ...
    <div id="sidebar-overlay" class="fixed inset-0 bg-slate-900/40 backdrop-blur-md z-40 hidden lg:hidden" onclick="toggleSidebar()"></div>

    <aside id="sidebar" class="w-72 bg-gradient-to-b from-emerald-700 via-emerald-600 to-medical-600 text-emerald-100 fixed h-full top-0 left-0 z-50 flex flex-col justify-between border-r border-emerald-500 shadow-xl -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out">
        ...
        <div class="p-4 border-t border-white/10 bg-white/5 backdrop-blur-sm">
            <a href="index.php?action=logout" class="flex items-center justify-center gap-2 w-full px-4 py-2 rounded-xl bg-white/10 hover:bg-rose-600 text-white text-xs font-semibold uppercase tracking-wider transition-all duration-200 border border-white/10 shadow-sm">
    ...
    <div class="flex-grow lg:pl-72 min-h-screen flex flex-col w-full">
        ...
        <header class="h-16 bg-white/75 backdrop-blur-md border-b border-slate-200/60 sticky top-0 z-30 px-4 sm:px-8 flex items-center justify-between shadow-xs">
            <div class="flex items-center gap-4">
                <button type="button" onclick="toggleSidebar()" class="lg:hidden w-10 h-10 rounded-xl bg-emerald-50 border border-emerald-200/60 flex items-center justify-center text-emerald-600 hover:bg-emerald-100 transition-colors" aria-label="Ouvrir le menu">
        ...
        <main class="p-4 sm:p-6 lg:p-8 flex-grow max-w-[1400px] w-full mx-auto main-content">
            <?= $content ?? '<div class="flex flex-col items-center justify-center py-24 text-slate-400 bg-white rounded-2xl border border-slate-100 shadow-xs"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-10 h-10 mb-4 text-emerald-500/40"><path stroke-linecap="round" stroke-linejoin="round" d="M20.25 7.5l-.625 10.632a2.25 2.25 0 0 1-2.247 2.118H6.622a2.25 2.25 0 0 1-2.247-2.118L3.75 7.5M10 11.25h4M3.375 7.5h17.25c.621 0 1.125-.504 1.125-1.125v-1.5c0-.621-.504-1.125-1.125-1.125H3.375c-.621 0-1.125.504-1.125 1.125v1.5c0 .621.504 1.125 1.125 1.125Z" /></svg><p class="text-sm font-medium text-slate-400">Aucun contenu disponible pour le moment.</p></div>' ?>
        </main>
